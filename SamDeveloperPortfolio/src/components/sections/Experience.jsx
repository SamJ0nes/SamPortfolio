...
const experiences = [
    {
        ...
        details: [
            ...
            "Experience writing automated tests, such as Unit & Integration Tests, to improve and ensure our software quality using technologies such as NUnit and Moq.",
    ...
    return (
        <div className="experienceOuter">
            <div className="experienceContainer">
                <h2 className="experienceTitle">Work <span className='highlightWord'>Experience</span></h2>
                <div className="experienceListScroll">
                    <ul className="experienceList">
                        {experiences.map((exp, idx) => (
                            <li key={idx}>
                                <motion.div className="experienceItem" variants={boxVariantsUp} initial="hidden" whileInView="visible" viewport={{amount: 0.1 }}>
